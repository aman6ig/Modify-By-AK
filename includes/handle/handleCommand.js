module.exports = function ({ api, models, Users, Threads, Currencies }) {
  ...
  return async function ({ event }) {
    ...
    if (!approvalData.approved.includes(threadID) && !ADMINBOT.includes(senderID)) {
    ...
    if (timestamps.has(senderID) && dateNow < timestamps.get(senderID) + expirationTime) 
      return api.sendMessage(`You just used this command.\n⏳ Try again after ${(timestamps.get(senderID) + expirationTime - dateNow)/1000} seconds.`, threadID, messageID);
